                        ...
                        <table border="1" class="tituloTabla" style="text-align: center" id="customers1" >
                            ...
                            foreach ($usuarios1 as $filas1) {
                                if ($filas1['perf'] != 'Administrador') {
                                    ...
                                    <td><button type="button" onclick="window.location.href = '../Mantenimiento/PerfilColaborador.php?dniusu=<?php echo $filas1['dniusu']; ?>&perf=<?php echo $filas1['perf']; ?>'">Perfil</button></td>
                                    <?php
                                }
                            }
                            ?>
