        ...
        <div class="wrapper col2">
            <div id="topbar">
                <div id="topnav" style="width:100%">
                    <ul>
                        <li style="max-width:250px" id="liaccionesprincipales" class><a href="../Administrador/FrmPrincipalAdmin.php">Acciones principales</a></li>
                        <!--<li><a href="pages/style-demo.html">Style Demo</a></li>
                        <li><a href="pages/full-width.html">Full Width</a></li>-->
                        <li class='active' id="liadministracion"><a href="#" onclick="return null">Administracion</a>
