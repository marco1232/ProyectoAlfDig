<?php 
    ...
    $nomuniver=$_POST['nomuniver'];
    if(isset($_POST['ciclo'])){$ciclo=$_POST['ciclo'];}{$ciclo='';}
    ...
    $nivelconoci=$windows.$internet.$correo.$word.$excel.$porwerpoint;
    $rdbExperiencia=$_POST['rdbExperiencia'];
    if($rdbExperiencia=='Si'){
        $descripdocen=$_POST['nivelconoci'];
    }else{
        $descripdocen='';
    }
